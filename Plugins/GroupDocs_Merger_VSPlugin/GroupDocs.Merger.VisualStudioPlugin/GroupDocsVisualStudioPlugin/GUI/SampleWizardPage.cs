...
using GroupDocsMergerVisualStudioPlugin.Core;
using System.IO;
using System.Threading;
using System.Xml;
using GroupDocsMergerVisualStudioPlugin.XML;
...
namespace GroupDocsMergerVisualStudioPlugin.GUI
{
    public partial class SampleWizardPage : Form
    {
        ...
        bool CopyAndCreateProject()
        {
            ...
            //string sampleSourcePath = "GroupDocs.Merger";
   ...
   TreeNode nodeToAddTo)
        ...
        private void rdbCSharp_CheckedChanged(object sender, EventArgs e)
        {
            ...
            GroupDocsComponents.list.TryGetValue(Constants.GROUPDOCS_COMPONENT, out component);
            string repoPath = GitHelper.getLocalRepositoryPath(component);
            PopulateTreeView(repoPath + "/Examples/" + (rdbCSharp.Checked ? "GroupDocs.Merger.Examples.CSharp" : "GroupDocs.Merger.Examples.VisualBasic"));
